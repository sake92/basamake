...
| Feature surface | focused — navigation, diagnostics, Scala hover and completion | very large | very large |
...
You give up much of the fancy stuff: rename refactoring, formatting, and workspace-wide
symbol search. For projects where you mainly navigate, read, edit, and iterate on compile
errors, Basamake is faster to start, lighter on resources, and more predictable than the
alternatives.
